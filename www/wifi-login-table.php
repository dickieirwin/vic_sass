...
<style type="text/css">
	...
	@media all and (max-width: 759px) {
		...
		*[class].wrap {display: inline-block !important;}
...
<div id='content'>
    <table id="page_header" class="top_spacer full-width" border="0" cellspacing="0">
        <tr>
            <td class="wifi_header_bar"></td>
        </tr>
    </table>
    <table id="main_table" class="logon_page entry highlight highlight_tertiary login_form full-width">
        <tr>
            <td class="intro full-width">
                <p>Welcome to Victoria. Login with your student or staff account to access our wifi.</p>
            </td>
        </tr>
        <tr>
            <td class="space full-width"></td>
        </tr>
        <tr>
            <td class="spacer full-width"></td>
        </tr>
        <tr>
            <td class="full-width">
                <table id="auth_form" class="form_large highlight full-width" name="e1" method="post" action="/my.policy" onsubmit="javascript: return masterSubmit(this);" autocomplete="off" width="100%">
                    <tr>
                        <td class="field_container wrap full-width">
                            <label for="user_name">User name</label>
                        </td>
                        <td class="field error wrap full-width">
                    ...
                    <tr>
                        <td colspan="2" class="form_actions spacer full-width"></td>
                    </tr>
                    <tr>
                        <td class="full-width"></td>
                        <td class="field_container wifi full-width">
