...
<!--[if !IE]><!--> <html lang='en' class='no-js nav_closed <?php if (isset($GLOBALS['_html_class']) && !empty($GLOBALS['_html_class'])) { print ' ' . $GLOBALS['_html_class']; } ?>'>        <!--<![endif]-->
    ...
    <head>
        ...
        <style>
        #masthead {background-color: #ef9a49; border-bottom:none;}
        #masthead .nav_main {margin-top: 24px; font-family: "National","Segoe WP Semibold","Nimbus Sans L",Arial,"Helvetica Neue","Helvetica",sans-serif;font-weight: 500;height:auto;margin-left: 11.25%;}
        #masthead .nav_main a {color:#282828; padding: 0 1em;line-height: 83px;}
        #masthead .nav_main li a:before {display: none;}

        #masthead a.vic_logo {background-image: url("/images/mld-logo.png");background-size: auto;
        height:83px;width:118px;}

        /*#pattern {background: url("/images/mld-pattern.png"); height:208px;}
        .has_big_search.search_page #wrapper {border-top-width: 0;}
        .has_big_search #page {margin-top: -134px; padding-top: 134px;}*/

        #pattern {background: url("/images/mld-pattern.png?") 0 center; height:60px;}
        .has_big_search.search_page #wrapper {border-top-width: 0;}
        .has_big_search #page {margin-top: -60px; padding-top: 60px;}

        .site_footer {background-color: #7c3108;}
    ...
    <div role='navigation' id='masthead'>
        ...
        <nav class='global_nav wrap'>
            <!-- <a href='homepage.php' class='vic_logo'>Maori Legal Dictionary</a> -->
            <ul class='nav_main'>
                <li><a href='homepage.php' class='vic_logo'>Maori Legal Dictionary</a></li>
                <li class='study'><a data-short-title='Study at Vic' href='study-hub.php'>Dictionary search</a></li>
                <li class='current_students'><a data-short-title='Students' href='students-hub.php'>Browse Corpus</a></li>
                <li class='research'><a href='research-hub.php'>Lexicon &amp; word lists</a></li>
                <li class='about_us'><a data-short-title='About' href=''>About</a></li>
<!--                 <li class='masthead_search'>
    ...
    <div id='wrapper'>
        ...
        <div id='page' class='wrap corpus_width_large'>
