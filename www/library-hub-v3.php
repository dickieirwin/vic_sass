...
$GLOBALS['_html_class'] = '';
$GLOBALS['_body_class'] = 'theme-library';
$GLOBALS['_html_title'] = 'The Library | Victoria University of Wellington';

includeFile('header.php');

?>

<!-- <link href="/assets/css/site-specific/library-v3.css" media="all" rel="stylesheet" type="text/css" /> -->
<link href="/assets/css/site-specific/library.css" media="all" rel="stylesheet" type="text/css" />
    ...
    <aside id='section_menu'>
        ...
        <div class='toggle_block'>
            <nav>
                <h2 class='menu_title'><a href=''>The Library</a></h2>
...
<li class=""><a href="/library-v2/content/general-collections" class="label">General Collections</a></li><li class=""><a href="/library-v2/content/digital-collections-0" class="label">Digital Collections</a></li><li class=""><a href="/library-v2/content/jc-beaglehole-room" class="label">JC Beaglehole Room</a></li><li class=""><a href="/library-v2/content/m%C4%81ori-and-pasifika-collections-0" class="label">Māori and Pasifika Collections</a></li>  </ul>
    ...
    <div id='content'>
        <?php includeFile('library-search-v3.php'); ?>
        <section role='main' class='primary'>
            ...
            <div id='hero' class='grid style1'>
                <a href='#'>
                    <div class='imagery'>
                        <img src='/images/hero_students_computer.jpg' alt='Students at a computer' />
                    ...
                    <div class='info wht w50 right0'>
                        <h3>Get Expert Help</h3>
                        <p>Subject Librarians are available daily...</p>
            ...
            <div class='entry'>
                <h1 class='page_title'>The Library</h1>
                <div class='intro'>
