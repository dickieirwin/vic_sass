...
$GLOBALS['_body_class'] = 'theme-research template-drilldown  no_sidebar';
...
?>
        ...
        <div class='toggle_block'>
            <nav>
                ...
                <ul class='section_tree'>
                    ...
                    <li class="current"><a class="current" href='ferrier_research.php'>Research</a></li>
    ...
    <div id='content'>
        <section role='main' class='primary'>
            ...
            <div class='entry'>
                    <h1 class='page_title'>Ferrier Research</h1>
                    <div class='intro'>
                ...
                <div class="blocks blocks-3col bleed_box">
                    <a class="link_block" href="#">
                        <h3 class=''>Chemical immunology</h3>
                        ...
                        <h3 class=''>Enzyme inhibitors</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
                        <h3 class=''>Pharmaceutical manufacture</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
                        <h3 class=''>Heparan sulphate</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
                        <h3 class=''>Functional biopolymers</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
                        <h3 class=''>Carbohydrates for health</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
                        <h3 class=''>Emergent science</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient</p>
                    </a><a class="link_block" href="#">
